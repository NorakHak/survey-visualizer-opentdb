...
interface AppContextI {
    ...
    setSelectedCategory: React.Dispatch<React.SetStateAction<TriviaCategory | null>>;
    setSelectedCategoryId: React.Dispatch<React.SetStateAction<number | null>>;
    setShowOverallChart: React.Dispatch<React.SetStateAction<boolean>>;
...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    const [showOverallChart, setShowOverallChart] = useState<boolean>(false)
    ...
    function resetCache() {
        ...
        for (const key in globalQuestionsCache) {
            delete globalQuestionsCache[key]
        }

        sessionStorage.removeItem('categoryStats')
